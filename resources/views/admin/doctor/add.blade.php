                    ...
                    <form  class="forms-sample" method='POST' action="{{ route('doctors.store') }}" enctype="multipart/form-data" > 
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{$user->ville}}" name="ville" class="form-control @error('ville') is-invalid @enderror" placeholder="ville" >
                                @error('ville')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="department" class="form-control">
                                    ...
                                    @foreach (App\Department::all() as $d)
                                        <option value="{{$d->department}}" @if($user->department==$d->department)selected @endif>{{$d->department}}</option>
                                    @endforeach
                                </select>
                                @error('department')
                                <span class="invalid-feedback" role="alert">
